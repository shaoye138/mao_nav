  ...
  <div v-else class="nav-home">
    ...
    <aside class="sidebar">
      ...
      <div class="logo-section">
        ...
        <h1 class="site-title">{{ title || '纵横导航' }}</h1>
      </div>
        ...
        <div v-else class="categories-container">
          ...
          <footer class="page-footer" hidden="true">
            ...
            <div class="footer-bottom">
              <p>&copy; {{ new Date().getFullYear() }} 纵横导航 - 由 <a href="https://t.me/ZHCHSL" target="_blank" rel="noopener noreferrer">maodeyu180</a> 用 ❤️ 制作</p>
              <p class="footer-tech">基于 Vue.js 构建 | <a href="https://t.me/ZHCHSL" target="_blank" rel="noopener noreferrer">点击</a></p>
            </div>
          </footer>
        </div>
      </div>
